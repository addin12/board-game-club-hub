...
export default function Home() {
  return (
    <div className="wrap">
      ...
      <nav className="grid">
        <Link className="tile" style={{ '--accent': 'var(--c-session)' } as React.CSSProperties} href="/session">
        ...
        <Link className="tile" style={{ '--accent': 'var(--c-all)' } as React.CSSProperties} href="/all">
        ...
        <Link className="tile" style={{ '--accent': 'var(--c-update)' } as React.CSSProperties} href="/update">
        ...
        <Link className="tile" style={{ '--accent': 'var(--c-sched)' } as React.CSSProperties} href="/schedule">
